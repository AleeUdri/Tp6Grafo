...
#Punto C
def hallar_arbol_de_expansion_minima_de_x_lugar(grafo, lugar):
...
def ejercicio_16():
    ...
    Crear_grafocompleto(grafo)
    
    print()
    print('Halla el camino mas corto entre dos lugares.')
    hallar_camino_mas_corto_entre_dos_lugares(grafo, 'Zeus', 'Zeus')
    
    print()
    print('Grafo de expansion minima.')
    hallar_arbol_de_expansion_minima_de_x_lugar(grafo, 'Hera')
